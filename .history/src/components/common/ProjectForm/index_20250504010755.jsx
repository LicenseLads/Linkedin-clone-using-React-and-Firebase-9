  ...
  <div className="form-entry-checkbox-row">
    <div className="form-entry-col">
      ...
      <input
        ...
        onChange={() => setProjectData({...projectData, label: "web_app"})}
    ...
    <div className="form-entry-col">
      ...
      <input
        ...
        onChange={() => setProjectData({...projectData, label: "research_project"})}
        className="form-checkbox"
        type="checkbox"
      />
    </div>
    <div className="form-entry-col">
      ...
      <input
        ...
        onChange={() => setProjectData({...projectData, label: "ai_project"})}
        className="form-checkbox"
        type="checkbox"
      />
    </div>
    <div className="form-entry-col">
      ...
      <input
        ...
        onChange={() => setProjectData({...projectData, label: "other"})}
        className="form-checkbox"
        type="checkbox"
      />
    </div>
...
<div className="form-entry-col">
  ...
  <input
    ...
    onChange={(e) => setProjectData({...projectData, has_github_repository: e.target.checked})}
  ...
  <div className="form-entry-checkbox-row">
    <div className="form-entry-col">
      ...
      <input
        ...
        onChange={() => setProjectData({...projectData, status: "done"})}
        className="form-checkbox"
        type="checkbox"
      />
    </div>
    <div className="form-entry-col">
      ...
      <input
        ...
        onChange={() => setProjectData({...projectData, status: "in_progress"})}
        className="form-checkbox"
        type="checkbox"
      />
    </div>
